...
> [1. Hotel](#hotel) ·
> [2. Bilety](#bilety) ·
> [3. Elastyczność dni](#elastycznosc) ·
> [4. Plan godzinowy D1–D8](#plan) ·
...
**✅ Zalecenie: 7-dniowy bilet Explore (25 €).** Jeśli w D2 i D4 (Valletta, Three Cities) jedziesz **autobusem 13/14/15 zamiast promu Sliema→Valletta**, te przejazdy też pokrywa karta — wtedy 7-dniówka wychodzi taniej i prościej. ⚠️ **Explore nie obejmuje linii „Tallinja Direct" (TD)** — one kosztują 3 €/przejazd dodatkowo. Wszystkie trasy w tym planie (poza opcjonalnym TD2 na lotnisko) używają zwykłych linii objętych kartą.

> 7-dniowa liczy od pierwszego użycia (D1 ~13:00) i pokrywa **cały pobyt**, także poranny dojazd 13/14/15+88 w D8 (wygasa ~06.10 13:00). **Oszczędzasz ~6,5 €.** Uwaga: na lotnisko najprościej TD2, ale to **+3 € i poza kartą** — dlatego w planie trasa 88 + 13/14/15 (w karcie).
>

**Osobno płacisz (nie wchodzi w kartę):**

- Szybki prom Valletta→Gozo (D3) — **~7,50 € w jedną (~15 € w obie)**, Gozo Highspeed (kup bilet online); alternatywa przez Sliema ~8,50 €/jedna strona; budżetowo prom Gozo Channel 4,65 €
- Blue Grotto rejs (D6) — **~10 €** (ok. 20–25 min; kupno na miejscu, bufor do 12)
- Comino prom Ċirkewwa→Comino (D5) — **~15 € return/os** (online ~14 €)
- Prom Valletta→Three Cities (D4) — **2,50–3 € one way / 4,50–5 € return** (taryfa dzienna; nocna 3,50/5,20)
- Wejścia do atrakcji
...
## 3. Elastyczność dni — co sztywne, co zalecane, co dowolne

| Dzień | Sztywne? | Uzasadnienie |
| --- | --- | --- |
| D1 wt · przylot | 🔒 twardo | lot przylotowy 12:05 — nie do zmiany |
| D8 wt · wylot | 🔒 twardo | lot wylotowy 12:30 — nie do zmiany |
| D6 nd · Blue Grotto + Marsaxlokk | 🔵 dowolne | targ rybny i tak zniknie do południa (Blue Grotto rano), więc **niedziela nie jest już kotwicą** — dzień łączony ze względu na długą trasę |
| D7 pon · Mdina + Rabat | 🔒 zalecane pon | **Muzeum Katedralne w Mdina zamknięte w niedziele**, otwarte w pon. Mdiny nie rób w niedzielę |
| D3 czw · Gozo | 🟡 zalecane dzień powszedni | promy szybkie codziennie, ale w weekend na Gozo tłoczniej; czwartek OK |
| D2 śr · Valletta | 🟡 zalecane wcześnie | St John's „na świeżo"; salut 12:00 codziennie. W zasadzie dowolne |
| D5 sob · Comino | 🔵 dowolne | Blue Lagoon rano — każdy dzień OK; weekend nieco tłoczniejszy (Notte Bianca wieczorem) |
| D4 pt · Three Cities | 🔵 dowolne | można przesuwać bez konsekwencji |

> Jedyne twarde punkty to loty (D1/D8) i Mdina w pon (D7, unikaj niedzieli). D6 nie jest już zależne od niedzieli. D4/D5 można dowolnie przestawiać — np. przy złej pogodzie na Comino zamienisz D5 z D4 lub D7 bez łamania zasad. Nie rób dwóch wysp (Gozo+Comino) ani dwóch miast (Valletta+Three Cities) z rzędu — na zmianę miasto/wyspa.
>

## 4. Plan dzień po dniu — godzinowo
...
| 08:40 | **Autobus 13/14/15 → Valletta** (~20–25 min) — **karta**; realne odjazdy z Rossu: 13 o **08:20/08:40**, 14 o **08:29/08:49** — celuj w **14 o 08:29** (Valletta ~08:50, przed 09:00) *(opcjonalnie prom ~10 min za ~2 €)* |
...
| 14:33 lub 15:33 | **307 Xaghra → Victoria** (~12 min; odjazdy z Xaghry co ~60 min: **13:32 · 14:33 · 15:33** · 16:31) — karta. **14:33 = wariant z Ta' Pinu** · **15:33 = wariant pewny** (po Ta' Kola) |
| 14:55–15:18 | ⚠️ **Ta' Pinu — TYLKO w wariancie 14:33 i jeśli świątynie zamknięte do ~14:20:** 308 Victoria **14:55** → Ta' Pinu ~15:05 → powrót tym samym kursem **15:18** (zwiedzanie ~10–13 min). Inaczej **pomiń** |
| 15:30 lub 16:00 | **301 Victoria → Mġarr** (co 15 min; **~18 min**) — karta → Mġarr **15:48** (wariant z Ta' Pinu; zapas 55 min) albo **16:18** (wariant pewny: 307 15:33 → Victoria 15:45 → 301 16:00; zapas 25 min) → **prom 16:45** (boarding zamykany 2 min przed — 16:43) |
| 16:45 | 🚤 **Szybki prom Mġarr → Valletta** (~45 min, ~7,50 €) → Valletta ~17:30 → **13/14/15 → Sliema** (~25 min, karta) → ~18:00 (z korkami do ~18:30). Alternatywa: powrót przez **Sliema** (Mġarr→Sliema **17:15 → ~18:30**, osobny bilet ~8,50 €). Odejścia Mġarr→Valletta co ~godzinę (ost. **20:45 → 21:30**) |
| 18:00 | Kolacja St Julian's — wieczór wolny |

> 🕐 Wyjdź z hotelu **07:20–07:30, nie później** (bus ~07:45 → prom 08:45), by mieć cały dzień na Gozo — boarding zamyka się **2 min przed odjazdem**, a Lascaris Wharf szuka się pierwszy raz dłużej. **Winda Barrakka: 1 € za bilet powrotny (góra i dół, ten sam dzień; gotówka) — płatna w każdą stronę** (zjazd w dół już nie jest darmowy); z return-promem w D4 winda gratis w obie strony; alternatywa: darmowy **X133** zsynchronizowany z promami lub ~10 min pieszo. Realny czas hotel → pokład to ~60–70 min (bus + zejście windą/X133). Liczba przejazdów: ~5 (bez długiej 222). **Lżejszy logistycznie niż wersja przez Ċirkewwę** i szybszy niż Sliema (bez przesiadki w Buġibbie).
>

### Dzień 4 · pt 02.10 — Three Cities autobus + prom do Birgu osobno

| Godz. | Co |
| --- | --- |
| 09:00 | **Autobus 13/14/15 Sliema → Valletta** (~20–25 min) — **karta** |
| 09:30 | **Prom Grand Harbour → Birgu/Vittoriosa** (~5–10 min, **2,50–3 € one way / 4,50–5 € return** — ceny zależne od operatora; po ~19:30 nocna **3,50 € one way / 5,20 € return**). **Barrakka Lift** — **1 € za bilet powrotny (góra i dół, ten sam dzień; gotówka)** — płatna w każdą stronę; z biletem **return promu winda w cenie w obie strony** (osobno płacisz tylko, gdy prom bierzesz w jedną stronę). 💡 Posiadacze **personalizowanej karty Tallinja** mają ten prom i windę za darmo — Explore (na okaziciela) raczej nie, zapytaj przy zakupie. |
| 10:00–11:30 | ⭐ **Fort St Angelo** (10 €) — ⚠️ średnio warta; historia + widoki |
| 11:30–12:30 | ◽ **Pałac Inkwizytora** 8 € ⚠️ · **Maritime Museum** 8 € ⚠️; max 1 |
...
> ✅ Dzień na wodzie, mało logistyki — dobra odskocznia po dwóch intensywnych dniach (Gozo D3, miasta D4). Dla wczesnego wejścia do Blue Lagoon wybierz **bezpośredni prom z Ċirkewwy/Marfy**, a nie rejs ze Sliemy — taniej (~15 € return/os) i szybszy dojazd. Wieczorem opcjonalna **Notte Bianca** w Valletcie.
>
...
> 🎉 **Opcjonalny wieczór D5 — Notte Bianca w Valletcie (sob 3.10):** darmowy festiwal sztuki — pałace, muzea i ogrody Valletty otwarte do późna (~19:00–4:00). Bonus po dniu na Comino. Jeśli się wybierzesz, wróć ok. **~21:30**, bo D6 (Blue Grotto rano) zaczyna się wcześnie.
>

### Dzień 6 · nd 04.10 — Blue Grotto (rano) + Marsaxlokk (obiad/klimat) 13/74/81/119/201 · karta 🕐

> ✅ Kolejność: **Blue Grotto NAJPIERW** — rano najlepsze światło (blask w jaskiniach do ~13:00) i najmniej ludzi. Potem Marsaxlokk na obiad/klimat (łódki luzzu, promenada, port). Niedzielny targ rybny jest **bonusem „best-effort"** — i tak zwykle zniknie do ~12:30, gdy my jesteśmy przy Blue Grotto, więc nie planujemy wokół niego.
>
...
| 11:45 | **Autobus → Marsaxlokk**: 201 z Wied iż-Żurrieq **12:15** → lotnisko **12:28** → **119** (nd **co 60 min**: z lotniska 13:00 → Marsaxlokk ~13:27) **lub** 74 → Valletta → 81/85; opcja direct **TD10** (nd, Valletta A6 → Marsaxlokk co ~10 min 09:15–16:35, **+3 € poza kartą**) — karta |
...
| 13:45–15:00 | ⭐ **Rabat** (pieszo ~10–15 min) — spokojniejszy, mieszkalny klimat. ◽ **Katakumby św. Pawła** 10 € ⚠️ · **Domus Romana** 6 € ⚠️ |
...
| 19:44 | **Autobus 51 Rabat (Saqqajja) → Valletta** — ostatni wygodny (⚠️ **202 z Rabatu kończy kursy o 18:00** — „20:30, 202" nie istnieje) → Valletta ~20:15 → **13 o 20:25 → Ross ~20:52** → hotel ~21:00, kolacja ~21:15. **Awaryjnie:** 51 **20:12/20:14** → Valletta ~20:38 → 13 o 20:55 → Ross ~21:22 |

> 💡 **Plan bazowy: Dingli jako popołudniowy widok, zachód z bastionów Mdiny.** Z bastionów słońce zachodzi **nad doliną/ lądem**, z klifów Dingli **nad otwartym morzem** — dlatego Dingli oglądamy po południu (15:45–17:25), a zachód (~18:42) z bastionów Mdiny — **pewny wariant** (201 co 60 min i koniec kursów 202 o 18:00 nie pozwalają na „zachód z klifów + wieczorna Mdina" w rozsądnych godzinach).
>
> 🌊 **Wariant „zachód nad morzem" (opcjonalny, tylko jeśli bardzo chcecie):** zostańcie w Dingli do ~18:50 (zachód 18:42) → 201 **19:37** → Rabat 19:45 → 51 **20:12/20:14** → Valletta ~20:38 → 13 o 20:55 → Ross ~21:22. Koszt: **wieczorna Mdina odpada** (zostają ~5 min przy bramie). Sprawdź 201 dzień wcześniej w Tallinja.
>

> ⚠️ **Zabezpieczenie:** 201 z Dingli co ~60 min — **ostatni rozsądny kurs 19:37** (kurs 20:37 istnieje, ale wtedy nie zdążysz na ostatni sensowny 51 (20:12/20:14) i zostaną tylko nocne linie — nie ryzykuj). Z Rabatu do Valletty: **51** — wygodny 19:44 (→ Valletta 20:15), najpóźniejszy sensowny 20:14 (→ Valletta 20:38; póżniej tylko nocne; 53 ~19:48 MF) → dalej 13/14/15. Na powrót z Mdiny **wsiadaj na pierwszym przystanku** (pełny autobus nie zatrzyma się na kolejnym). ◽ **Rotunda w Moście**: gdybyś jechał 51/52/53 przez Mostę, możesz wysiąść na ~20 min, potem dalej do Mdiny — ale to tylko przy zapasie czasu.
>

### Dzień 8 · wt 06.10 — Wylot 13/14/15 + 88

| Godz. | Co |
| --- | --- |
| 08:20–08:30 | Wyjazd z hotelu: **13/14/15 → Valletta** (karta; bądź na Rossie ~08:25–08:35) → **88 → lotnisko** (karta). ⚠️ **88 z Valletty we wtorek co 20 min** (08:50 · 09:10 · **09:30** · 09:50 · 10:10; **przejazd ~35–37 min**) — celuj w **09:10 → lotnisko ~09:47**; zapas 09:30 → **10:07** (2 h 20 min przed odlotem); poślizg 09:50 → 10:27 (2 h — ciasno, wtedy TD2/TD3). Awaryjnie **TD2/TD3** (~3 € poza kartą, ~30–35 min — miej 3 € w zanadrzu). Spokojny poranek: śniadanie, spakowanie; **check-out do 10:00** |
| ~09:47–10:10 | Na lotnisku (**2 h 20 min–2 h 45 min przed odlotem 12:30** — tyle zaleca Malta Airport dla lotu w **Schengen**; 3 h to tylko non-Schengen/long-haul). **Karta nadal ważna** (wygasa ~06.10 ok. 13:00); awaryjnie miej ~2,50 € na bilety. Opcja szybsza/direct: **nie planuj na tym powrotu** — linia **X2 już nie kursuje** — direct na lotnisko to **TD2/TD3 (poza Explore, 3 €)**; pewny wariant to **13/14/15 + 88** (karta) |

## 5. Oceny atrakcji — co warte, co opcjonalne

Legenda: ⭐ = warta (polecam) · ✅ = warta · ⚠️ = średnio/opcjonalnie · 🚫 = można pominąć.

### Valletta (D2)

| Atrakcja | Cena | Ocena |
| --- | --- | --- |
| **St John's Co-Cathedral** (Caravaggio, audio-guide) | 15 € | ⭐ WARTE — barok na miarę Rzymu, najlepsze wnętrze Malty |
| **Upper Barrakka Gardens + salut 12:00** | bezpłatnie | ⭐ WARTE — najlepszy widok na Grand Harbour |
...
| Atrakcja | Cena | Ocena |
| --- | --- | --- |
| **Victoria / Citadella** | bezpłatnie | ⭐ WARTE — panorama i mury |
| **Świątynie Ġgantija / Ta' Kola combo** | 10 € | ⭐ WARTE — starsze niż piramidy, UNESCO |
| **Bazylika Ta' Pinu** | bezpłatnie | ✅ warte, klimatyczne |
| **Pola solne** | bezpłatnie | ✅ opcjonalnie, ciekawe |
| **Ramla Bay / Xlendi Bay (plaża)** | bezpłatnie | ✅ opcjonalnie, jeśli czas na kąpiel |

### Three Cities (D4)

| Atrakcja | Cena | Ocena |
| --- | --- | --- |
| **Gardjola Gardens (Senglea)** | bezpłatnie | ⭐ WARTE — jeden z najlepszych widoków na Vallettę |
| **Fort St Angelo** | 10 € | ⚠️ średnio — widoki i historia, ale część uroku widzisz za darmo |
| **Pałac Inkwizytora** | 8 € | ⚠️ opcjonalnie, historia |
| **Maritime Museum** | 8 € | ⚠️ opcjonalnie, morska historia |
| **Darmowy widok z Barrakki** | bezpłatnie | ✅ WARTE — najlepszy widok na port za darmo |
| **Tradycyjna dgħajsa (łódka)** przez port | ~3–5 € | ✅ rekomendacja — tani klimat i widoki z wody |
| **Rejs po Grand Harbour** | 15–25 € | ◽ alternatywa — tylko jeśli chcesz dłuższy, pełniejszy rejs |
...
| Atrakcja | Cena | Ocena |
| --- | --- | --- |
| **Niedzielny targ rybny** | bezpłatnie | ⭐ WARTE — najbardziej „malteski" widok |
| **Łodzie luzzu + port** | bezpłatnie | ⭐ WARTE |
| **Blue Grotto — rejs łódką** | ~10 € | ⭐ WARTE, ale **tylko rano** (przed ~13:00); po południu światło i tłumy gorsze. ⚠️ Zależny od pogody/morza |
| **Blue Grotto — punkt widokowy z klifu** | bezpłatnie | ✅ warte, nawet bez rejsu |
| **Ħaġar Qim + Mnajdra** (UNESCO) | 10 € | ⭐ warte dla lubiących prehistorię; spektakularna lokalizacja nad klifem |
| **St Peter's Pool** (kąpielisko) | bezpłatnie | ✅ opcjonalnie, ładna zatoka (dojście ~20–30 min pieszo) |

### Mdina + Rabat (D7)

| Atrakcja | Cena | Ocena |
| --- | --- | --- |
| **Mdina — spacer + bastiony** | bezpłatnie | ⭐ WARTE — największy „must" całego dnia |
| **Brama Mdiny / uliczki / widoki** | bezpłatnie | ⭐ WARTE |
...
| **Klify Dingli (zachód słońca)** | bezpłatnie | ✅ warte widoku, ale uwaga na rzadkie autobusy wieczorem |
...
Ceny orientacyjne: przekąska **€0,50–8** · prosty lunch **ok. €10–18** · lokal średniej klasy **ok. €20–35** · lokal premium **od ok. €45/os**. Same symbole $/$$/$$$ nie są pewnym dowodem ceny — licz z menu.

| Dzień / miejsce | 🍴 Rekomendacje (główna opcja · tańsza opcja / przekąska) |
| --- | --- |
...
| Pozycja | Kwota |
| --- | --- |
| **7-dniowy Explore (autobusy D1–D8)** | 25 € |
| Prom Valletta→Three Cities (D4) | 4,50–5 € (return) |
| Barrakka Lift (D3 + D4: **1 € za bilet powrotny**, płatny w każdą stronę; w D4 gratis z return promu; ew. X133/pieszo za 0 €) | 1–2 € |
...
- **7-dniowy Explore (25 €)** pokrywa **wszystkie autobusy D1–D8** — także dojazd do Valletty w D2/D3 (13/14/15 zamiast promu).
...
Zebrane z blogów (m.in. zLukaszem, podrozepoeuropie, proste-podroze, podrozebezosci, zyciewpodrozy, wheretravelmarta, travelfairy, pioremprzezswiat).

### Godziny / kolejki (najczęściej powtarzane)

- **St John's Co-Cathedral** — blogi polecają rezerwację online w sezonie, by ominąć kolejkę. Potwierdza „bądź na otwarciu 09:00".
...
- **Autobusy potrafią się spóźniać i bywają pełne** — „nie polegaj na rozkładzie"; „wracając z Mdiny stój na pierwszym przystanku, bo pełny autobus nie zatrzyma się na kolejnym".
- **W miastach straszne korki** — uwzględnij opóźnienia; autobus z lotniska potrafił przyjechać ±30 min.
- **Kierowca nie zawsze ma resztę** — płać kartą zbliżeniową lub miej odliczone.
- **Explore Card nie działa na linie TD** (jest ich niewiele; do wszystkiego w planie dojedziesz bez nich).
- **Woda z kranu** — „zdatna, ale słony smak"; lepiej butelkowana.
- **Gniazdka typu G (brytyjskie)** — zabierz przejściówkę (to kluczowe!).
- **Plaże piaszczyste są nieliczne** — na Malcie Golden Bay, na Gozo Ramla Bay; reszta to klify/skaliste kąpieliska.
- **Gozo warto dać dodatkowy czas** — część blogerów sugeruje nocleg na Gozo; u nas jeden intensywny dzień wystarczy, ale bez ściemy: nie zdążysz „wszystkiego".
- **Bilety do wnętrz i rejsy** — St John's i Ġgantija to „pewniaki", a muzea/drogie show (Malta Experience) można pominąć bez żalu.

## 9. Co zarezerwować wcześniej online (z linkami)

Sprawdzone na 2026. Niektóre rzeczy **trzeba** zarezerwować, inne **warto** (kolejki).

### 🔴 Zarezerwuj wcześniej online

### 1. Comino / Blue Lagoon — bezpośredni prom z Ċirkewwy/Marfy + darmowy landing pass

- **Najlepsza opcja dla planu D5:** bezpośredni prom z **Ċirkewwy/Marfy** (Comino Ferries) — **15 € return/os**. Online bywa ~14 € (oszczędzasz ~1 €), ale **w budżecie przyjmij 15 €**.
- ✅ Bilet jest **ważny 3 mies. i elastyczny** — bez przypisanej godziny/dnia; wchodzisz na pokład w **dowolnym punkcie odjazdu** (Marfa ~08:30 / Ċirkewwa ~08:40 pierwsze kursy). ⚠️ Nie rezerwuje konkretnego odejścia — kup online, ale **przyjedź odpowiednio wcześnie na wybrany kurs** (uwzględnij kolejkę).
- **Landing pass:** jeśli planujesz **zejść na ląd** przy Blue Lagoon, najpierw zarezerwuj **darmowy poranny slot AMS** (**08:00–13:00**, formularz pokazuje „Morning"), a przy zakupie Comino Ferries sprawdź, czy potwierdzenie rzeczywiście zawiera dostęp/QR. Jeśli nie — pobierz bezpłatny pass z AMS → https://blcomino.com/product/blue-lagoon/ · bilety: https://www.cominoferries.com/buy-tickets-ferry/. ⚠️ Comino Ferries obecnie deklaruje, że ich boarding pass obejmuje wejście i nie wymaga dodatkowego QR — ale **nie rozstrzygaj tego bezwarunkowo**; zweryfikuj po zakupie. Jeśli zostajesz na łodzi i nie schodzisz do kontrolowanego obszaru — pass niepotrzebny.
- **Rejs ze Sliemy to osobna, droższa opcja** (ok. 28–40 €): sprawdź konkretną ofertę, bo ceny, godziny, długość postoju i slot landing passu zależą od wybranego rejsu (niektóre wymagają popołudniowego 13:30–17:30). Nie wybieraj ogólnej kategorii GetYourGuide ze Sliemy — to nie konkretna oferta.
- **Werdykt dla D5:** dla zwykłego transportu na Comino domyślnym wariantem jest Comino Ferries z **Ċirkewwy/Marfy** — **15 € return/os**. To zwykle **znacznie taniej** niż pełnodniowy rejs ze Sliemy, ale określenie „~2× taniej" jest prawdziwe tylko przy porównaniu z ofertą za ok. 30 € (przy rejsie za 40 € różnica jest większa). Comino Ferries **nie jest równoważnikiem rejsu widokowego** — sprawdź osobno, czy konkretna oferta obejmuje oglądanie jaskiń lub Crystal Lagoon (Crystal Lagoon to głównie atrakcja oglądana od strony wody; z lądu dojdziesz głównie do punktów widokowych). Droższy rejs ze Sliemy bierz **tylko**, jeśli (a) nie chcesz ogarniać landing passu (zostajesz na łodzi), (b) chcesz jaskinie/Crystal Lagoon z pokładu albo (c) wolisz wygodę bez logistyki dojazdu.

### 2. Szybki prom na Gozo — D3, domyślnie z Valletty (decyzja)

Gozo Highspeed to pasażerski prom (tylko pieszo, bez auta). **Domyślnie w D3 startujemy z Valletty** — z Sliemy jedziemy autobusem 13/14/15 na karcie (~25 min) na dworzec, a z terminala **Lascaris Wharf** (pod murami — zejście windą Barrakka 1 € (bilet powrotny) / darmowym X133 / ~10 min pieszo) mamy **bezpośredni rejs ~45 min** — szybszy oraz tańszy niż trasa przez Buġibba (Comino w D5 zostaje przez Ċirkewwę).

- **Domyślne — Valletta → Gozo:** **~45 min bezpośrednio** do Mġarr, **~7,50 € w jedną (~15 € w obie)**, całoroczne. Dojazd z Sliemy na karcie (13/14/15, ~25 min). Kup bilet online.
...
- **Valletta → Gozo:** co ~godzinę; poranne **08:45 → 09:30**, **09:45 → 10:30**; ostatnie **20:45 → 21:30** i **22:15 → 23:00** (kurs 22:15 tylko pt–sob — w czw 1.10 go nie ma, ale my wracamy wcześniej).
- **Sliema → Gozo (przez Buġibba, alternatywa):** w sezonie; poranne odejścia ze Sliemy **06:45 · 08:45 · 09:45 · 11:45** → Mġarr ~1 h 15 min później (08:45 → ~10:00).

**Powroty z Mġarr na D3 (czw 1.10):**

- **→ Valletta:** co ~godzinę od **05:45 do 20:45** → Valletta ~45 min później; ostatni standardowy **20:45 → 21:30** i **22:15 → 23:00** (pt–sob). **Bierz kurs 16:45** → St Julian's ~18:00 (z korkami do ~18:30). **17:45 jest za późno** — → Valletta 18:30 → St Julian's ~19:15, poza oknem „~18:00–19:00".
- **→ Sliema (przez Buġibba, alternatywa):** odejścia **15:15 · 17:15 · 18:15 · 20:15 · 21:15**; **17:15 → ~18:30** prosto do Sliemy — osobny bilet ~8,50 €. Użyj, jeśli wolisz wracać do St Julian's bez przesiadki.

**Rezerwacja:** taryfy https://gozohighspeed.com/pages/fares · rozkład https://gozohighspeed.com/pages/schedule · bilet https://gozohighspeed.com/booking (lub ferryhopper.com). Na konkretny poranny kurs **kup bilet wcześniej online** — rezerwacja online zamyka się ~20 min przed rejsem, wejście na pokład i kasa zamykane 2 min przed odjazdem. Walk-on nie jest formalnie wykluczony (operator ma też kasę), ale przy kursie 08:45 nie warto ryzykować. ⚠️ Operator informuje o czasowych zmianach dojścia do terminala promowego w Mġarr (do 31.10) — dolicz kilka–kilkanaście minut na dojście wg oznaczeń na miejscu.
...
### 🟡 Warto sprawdzić / rozważyć

### 3. St John's Co-Cathedral (Valletta) — bilet

- **Cena:** **15 €** dorosły (senior/student 12 €).
- **Godziny:** pon–sob **09:00–16:45**, ostatnie wejście **dokładnie o 16:00**.
- **Kup:** najlepiej przez **oficjalny checkout fundacji na ShowsHappening** → https://www.showshappening.com/st-johns-co-cathedral-foundation/st-john-s-co-cathedral-admissions-ticket?p=website (tam kieruje oficjalna strona katedry). Zapasowy link: https://www.stjohnscocathedral.com/buy-tickets/. ⚠️ Przy zakupie online może pojawić się dodatkowa **booking fee** — sprawdź kwotę końcową w checkoucie. Wariant awaryjny: wejście na miejscu od 09:00 — ale sprawdź aktualność godzin przed wyjazdem.
- ⚠️ **Ostrzeżenie:** *nie kupuj biletów od nieautoryzowanych pośredników*. **Nie traktuj GetYourGuide/Viator jako oficjalnego kanału sprzedaży samego biletu**; wycieczkę zewnętrzną bierz tylko, jeśli oferta wyraźnie potwierdza oficjalne wejście.

### 4. Heritage Malta Multisite Pass — 30–60 €, nie opłaca się przy obecnym zestawie

- **Ceny:** dorosły **60 €** · senior/student **45 €** · ważność **30 dni** od pierwszego użycia.
...
- **Bilet autobusowy Explore 7 dni (25 €)** — Malta Public Transport Sales Office w Welcomer's Hall na lotnisku (oficjalne godziny ok. 08:00–19:30) albo automat biletowy / autoryzowane punkty (Agenda, 8TillLate, WH Smith). Link do sprzedaży: https://www.publictransport.com.mt/office-and-ticket-machine/ · https://www.publictransport.com.mt/fares-and-tickets/. ⚠️ Oficjalne strony MPT są niespójne co do Airport Direct/TD — dla bezpieczeństwa **nie zakładaj darmowego TD2/TD3/Airport Direct** Awaryjnie przyjmij **3 € za TD2/TD3** albo **3,50 € za TD1** i potwierdź zasady przy zakupie karty.
- **Szybki prom Gozo Highspeed** (Valletta→Mġarr, ~7,50 € w jedną (~15 € w obie); alternatywa przez Sliema ~8,50 €) — kup bilet online (patrz §2). Budżetowo zamiast tego: prom Gozo Channel (Ċirkewwa→Mġarr, 4,65 €, bilet pasażera powrotny, bez rezerwacji, first-come-first-served).
- **Prom Valletta→Three Cities** — ~3 € one way / 4,50–5 € return (poza zwykłym Explore), na miejscu.
- **Mdina, Rabat, Fort St Angelo, Pałac Inkwizytora** — standardowe wejścia zwykle kupisz na miejscu, ale część obiektów ma też oficjalną sprzedaż online; przed wizytą sprawdź godziny otwarcia, ostatnie wejście i ewentualne zamknięcia. Nie zakładaj wyłącznie gotówki.
...
| Gozo — domyślnie szybki prom z Valletty (Gozo Highspeed, ~7,50 € w jedną (~15 € w obie); alternatywa przez Sliema ~8,50 €) — dojazd busem 13/14/15, kup bilet online na kurs 08:45. Budżetowo zamiast tego: 222 + Gozo Channel (~4,65 € w obie) | ⬜ |
| St John's Co-Cathedral — kup bilet przez oficjalny link fundacji (showsHappening) https://www.stjohnscocathedral.com/buy-tickets/ | ⬜ |
| Heritage Malta Multisite Pass (30–60 €) — tylko jeśli suma konkretnych biletów wynosi co najmniej 60 €; przy obecnym zestawie ≈42 € dla dorosłego (z Ħaġar Qim) kupuj pojedynczo/Rabat Combo (nie ma automatu „od 4 obiektów" — liczy się realna suma) | ⬜ |
...
Plan: 29.09–06.10 · Vegas Resort (St Julian's – Paceville) · 7-dniowy Explore 25 € · Gozo D3 (szybki prom z Valletty), Comino D5 (prom z Ċirkewwy), Mdina D7. Budżet ~128 €/os. przy szybkim Gozo albo ~117 €/os. przy wariancie Gozo Channel — **orientacyjnie transport + bilety wstępu (dorosły), bez jedzenia, noclegu, lotów i zakupów**. Do wariantu online dolicz możliwą booking fee St John's oraz bufor na Airport Direct (3–3,50 €).
