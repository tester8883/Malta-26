...
| 12:05 | **307 → Xagħra** (~12 min) — karta. ⚠️ **307 z Victorii co 60 min** (11:05 · 12:05 · 13:05 · 14:05) — jeśli nie zdążysz na 12:05, jedź 13:05 (wtedy Ġgantija 13:20–14:50) |
...
| Godz. | Co |
| --- | --- |
| 07:15 | Wyjście z hotelu → przystanek **San Giljan – Ross** (~5 min pieszo; na miejscu ~07:20) |
...
### Dzień 7 · pon 05.10 — Mdina + Rabat + klify Dingli (po południu) → zachód słońca z bastionów Mdiny 202 + 201 · karta 🕐
...
| Atrakcja | Cena | Ocena |
| --- | --- | --- |
| **Niedzielny targ rybny** | bezpłatnie | ⭐ WARTE — najbardziej „malteski" widok; ⚠️ w naszym planie (przyjazd ~12:45 po Blue Grotto) rybna część zwykle już zwinięta — zostają stragany, luzzu i port |
...
| Pozycja | Kwota |
| --- | --- |
| **7-dniowy Explore (autobusy D1–D7; D8: TD2 +3 €)** | 25 € |
...
- **St John's:** czynne pon–sob 09:00–16:45, ostatnie wejście ~16:00 (niedziele zamknięte), **muzeum katedralne zamknięte — remont/rozbudowa** (oficjalna strona).
...
| --- | --- | --- | --- | --- |
| 🥇 **Welbee's Paceville** (Pendergardens, Triq Gort, STJ 1901) | **~370 m / 5 min** | pon–nd **7:30–22:00** | [maps](https://www.google.com/maps?q=35.922162,14.487596) | średnia (15–30% drożej od Lidla). Najbliższy duży sklep — pierwsze zakupy w D1 (woda, śniadania, przekąski); ~250 m od przystanku **Ross**, praktycznie po drodze do hotelu |
...
| **Eurospin** (Mosta, Triq id-Difiża Ċivili, MST 1743 — obok Lidla) | ~11 km — tylko przy okazji | 7:00–22:00 | [maps](https://www.google.com/maps?q=35.918406,14.422436) | dyskont (włoskie marki). Jedyny Eurospin na Malcie; wpada w **D7** (202 do Mdiny przejeżdża przez Mostę), ale to +40–60 min |
| **Lidl Mosta** (Triq id-Difiża Ċivili, MST 1743 — **obok Eurospinu**) | ~11 km — przy okazji | **codziennie 7:00–22:00** | [maps](https://www.google.com/maps?q=35.918030,14.420780) | najtańsza; duet „Lidl + Eurospin” w jednym miejscu (Mosta) |
| **Lidl Luqa** (Triq il-Karmnu, LQA 1311 — przy lotnisku) | ~10 km (lotnisko) | **codziennie 7:00–22:00** | [maps](https://www.google.com/maps?q=35.860800,14.484940) | najtańsza; tylko z autem/taksówką — **nie w D1** (patrz niżej) |
| ⚠️ **Convenience** (tylko awaryjnie, +30–80%): Little Greens (Triq San Ġorġ 123) [maps](https://www.google.com/maps?q=35.923101,14.489810) [24/7] · Spar Express (Triq San Ġorġ 110) [maps](https://www.google.com/maps?q=35.922275,14.490153) [24/7] · MyConvenience (Paceville) [maps](https://www.google.com/maps?q=35.923385,14.488873) [6:00–24:00] · Daves (Triq is-Sidra, Swieqi) [maps](https://www.google.com/maps?q=35.920203,14.482025) [24/7] | 90–910 m | całodobowo | — | nocna woda/przekąska; nie robić tu większych zakupów |
| 🥟 **PolMalta Polish Shop** (3A Lapsi Street, STJ 1011) | ~670 m | pon–sob 11:00–19:00 | [maps](https://www.google.com/maps?q=35.918307,14.490414) | polskie produkty |

> ✈️ **Czy opłaca się kupować „w drodze z lotniska”?** **Lidl Luqa** (Triq il-Karmnu; [maps](https://www.google.com/maps?q=35.860800,14.484940)) jest ~0,9–1,2 km od terminala (~12–15 min pieszo; przystanki **Taljana** ~70 m / **Tumas** ~110 m, linie z Luqi m.in. 71/72/73/117/218), otwarty 7:00–22:00. **Werdykt: nie w D1** — z walizkami dojście + potem przejazd do Paceville (88 przez Vallettę / X2 przez Sliemę) to realnie **+45–70 min** i taszczenie zakupów, a po drodze i tak nie ma przystanku „pod drzwiami” Lidla. Zakupy zrób pieszo przy hotelu (Welbee's/Pavi-Pama), a po Lidla idź w D2 do Sliemy. Lidl Luqa ma sens tylko z autem/taksówką (Bolt ~10–15 €).
...
> 📍 **Skąd te punkty:** 4 sklepy Lidl — **oficjalne dane lokalizacyjne z kart sklepów lidl.com.mt** (JSON-LD); pozostałe — **OpenStreetMap / Overpass** (punktowe POI sklepów, nie centroida miasta). Wszystkie sprawdzone 20.09.2026 geokodowaniem zwrotnym (Nominatim) — każdy link `[maps]` prowadzi dokładnie do danego sklepu (bez przybliżeń, liczby celowo pomijamy w opisach).
>
...
- **Explore Card nie działa na linie TD** (jest ich niewiele; w planie używamy tylko TD2 na lotnisko w D8 — 3 € — reszta tras bez nich).
...
- **Valletta → Gozo:** co ~godzinę; poranne **08:45 → 09:30**, **09:45 → 10:30**; wieczorem **21:45 → 22:30**, **22:45 → 23:30**, **23:45 → 00:30** (codziennie 19.06–31.10; **00:45 → 01:30** tylko pt–nd) — my wracamy 16:45, więc bez wpływu.
...
- **→ Valletta:** od **05:45 do 23:45** (co ~godzinę, z przerwą 08:45) → Valletta ~45 min później; **20:45 → 21:30**, **21:45 → 22:30**, **22:45 → 23:30**, **23:45 → 00:30** (codziennie 19.06–31.10; **00:45 → 01:30** pt–nd). **Bierz kurs 16:45** → St Julian's ~18:00 (z korkami do ~18:30). **17:45 jest za późno** — → Valletta 18:30 → St Julian's ~19:15, poza oknem „~18:00–19:00".
...
- **Godziny:** pon–sob **09:00–16:45**, ostatnie wejście **dokładnie o 16:00** (niedziele/święta zamknięte); **muzeum katedralne zamknięte — trwa remont/rozbudowa** (stan z oficjalnej strony, 08.2026).
...
| Tallinja Explore 7 dni (25 €) — kup i **aktywuj od razu w D1 (29.09, pierwsze przyłożenie na 88)**; ważność = 7 dni kalendarzowych → **do 05.10**. **D8 (06.10): TD2 z przystanku Dragonara (~100 m od hotelu) 09:34 → lotnisko ~10:02 (3 €, poza kartą, bez przesiadki)**. Przy zakupie potwierdź, że TD/Airport Direct są poza kartą | ⬜ |
